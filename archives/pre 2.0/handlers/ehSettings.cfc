...
<!--- ************************************************************* --->
	...
	<cffunction name="dspGeneralSettings" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset requestContext.setView("settings/vwSettings")>
	</cffunction>
	...
	<cffunction name="dspLogSettings" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset requestContext.setView("settings/vwLogFileSettings")>
	</cffunction>
	...
	<cffunction name="dspEncodingSettings" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset requestContext.setView("settings/vwFileEncodingSettings")>
	</cffunction>
	...
	<cffunction name="dspChangePassword" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset requestContext.setView("settings/vwPassword")>
	</cffunction>
	...
	<cffunction name="dspProxySettings" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset requestContext.setView("settings/vwProxySettings")>
	</cffunction>
