...
<cfcomponent name="ehUpdater" extends="coldbox.system.eventhandler">
	...
	<cffunction name="dspUpdateSection" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset requestContext.setView("vwUpdate")>
	</cffunction>
	...
	<cffunction name="dspUpdater" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset requestContext.setView("update/vwUpdater")>
	</cffunction>
	...
	<cffunction name="docheckForUpdates" access="public" returntype="void">
		...
		<!--- Param Site--->
		<cfset requestContext.paramValue("distribution_site", "")>
		<cftry>
			<!--- Check for URL --->
			...
			<!--- Get a WS Object --->
			<cfset updateWS = CreateObject("webservice",requestContext.getValue("distribution_site"))>
			<!--- Check for Updates --->
	...
	<cffunction name="dspUpdaterResults" access="public" returntype="void">
		...
		<!--- Set the View --->
		<cfset requestContext.setView("update/vwUpdaterResults")>
	</cffunction>
	...
	<cffunction name="doGetUpdate" access="public" returntype="void">
		...
		//param type
		requestContext.paramValue("updatetype", "");
	...
	<cffunction name="doRemoveFile" access="public" returntype="void">
		...
		<cfset var Filename = requestContext.getValue("filename")>
		<cfset var FilePath = requestContext.getValue("filepath")>
		<cftry>
			<!--- Remove File --->
	...
	<cffunction name="doDeliverFile" access="public" returntype="void">
		<cfset var DeliverFile = replace(urlDecode(requestContext.getValue("backupfile")),"{sep}",getSetting("OSFileSeparator",1))>
