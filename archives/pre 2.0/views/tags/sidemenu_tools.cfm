	...
	<div class="sidemenu_toolbar_option">
	 <img src="images/icons/logout.gif" id="btn_logout" srcoff="images/icons/logout.gif" 
 	  srcon="images/icons/logout_on.gif" align="absmiddle" border="0" alt="Logout of the Dashboard">
		<a href="##" onClick="validateLogout() ? parent.window.location='index.cfm?event=#requestContext.getValue("xehLogout")#' : null" onMouseOver="rollover(btn_logout)" onMouseOut="rollout(btn_logout)" title="Logout of the Dashboard">Logout</a>
	</div>
</div>
</CFOUTPUT>